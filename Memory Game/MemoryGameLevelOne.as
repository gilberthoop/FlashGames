package {
	...
	public class MemoryGameLevelOne extends Sprite {
		static const numLights:uint = 5;
		static const multiLights:uint = 2;
		...
		var freePlace:Boolean;	//check collision
		
		public function MemoryGameLevelOne() {
			// text formating
			...
			for (var j:uint=0;j<multiLights;j++) {
				for(i=0;i<numLights;i++) {
					...
					thisLight.x = randomNum(1100)+150;	// position // changed the range
